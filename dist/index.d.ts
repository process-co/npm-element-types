...
export type { CallableImplementationKind, CallableResourceScope, CallableVersionSelector, CallableContract, CallableResourceReference, CallableInvocationDefinition, CallableRetryPolicy, CallableInvocationErrorPolicy, CallableInvocationIdentity, CallableInvocationEnvelope, CallableInvocationPolicySnapshot, CallableErrorEnvelope, CallableSettlement, CallableRecoveryDecision, } from './callable-resource';
export { ObjectProjectionDocumentSchema, CallableVersionSelectorSchema, CallableResourceReferenceSchema, CallableInvocationDefinitionSchema, CallableInvocationIdentitySchema, CallableInvocationEnvelopeSchema, CallableInvocationPolicySnapshotSchema, CallableErrorEnvelopeSchema, CallableSettlementSchema, CallableRecoveryDecisionSchema, } from './callable-resource';
...
export type SignalLifecycleHookHostServices = SignalHookHostContext & Pick<SignalRunHostServices, 'export'>;
...
export declare function resolveSignalHookIsDraft(ctx: SignalHookDraftContextInput): boolean;
...
export type SignalHostHookMethod<T> = (this: DeriveSignalHookInstance<T>, params: SignalHostHookParameters) => unknown | Promise<unknown>;
export type SignalSaveHookMethod<T> = (this: DeriveSignalHookInstance<T>, params: SignalSaveHostParameters) => unknown | Promise<unknown>;
