...
export type ObjectProjectionValueType = 'string' | 'number' | 'integer' | 'boolean' | 'object' | 'array' | 'null' | 'unknown';
 ...
 */
export type ObjectProjectionWritePolicy = 'error' | 'first' | 'last' | 'replace' | 'deepMerge' | 'append' | 'keyed';
...
//# sourceMappingURL=object-projection.d.ts.map